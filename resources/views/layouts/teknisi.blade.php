...
<head>
    ...
    /* ============================================
                   SIDEBAR KIRI - STICKY (SAMA SEPERTI ADMIN)
                   ============================================ */
    .app-sidebar {
        position: sticky;
        top: 0;
    ...
    /* Sidebar footer dengan info user */
    .sidebar-footer {
        padding: 16px 24px;
    ...
    .sidebar-footer .user-info .avatar-sm {
        width: 36px;
        height: 36px;
        border-radius: 50%;
        background: #206bc4;
        ...
        <aside class="app-sidebar" id="appSidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav flex-column">
                    ...
                    <!-- Daftar Tugas -->
                    <li class="nav-item {{ request()->routeIs('teknisi.tasks.*') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('teknisi.tasks.index') }}">
            ...
            <div class="sidebar-footer">
                <div class="user-info">
                    ...
                    <div class="user-details">
                        ...
                        <div class="role">
                            <i class="fas fa-wrench me-1" style="font-size: 10px;"></i>Teknisi
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <a href="{{ route('notifications.read', $notif->id) }}"
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0">
                                                    ...
                                                    @elseif($notif->data['type'] == 'new_task')
